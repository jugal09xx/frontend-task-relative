...
import ethbig from "../assets/ethbig.svg"
  ...
  return (
    ...
    <div className="flex flex-col content-center items-center text-center customCard">
      <div className="iconBox">
        <div className="icon">
            <div className="coinLogo3">
                <img width={60} src={ethbig} alt="bitcoinLogo"/>
            </div>
        </div>
      </div>
      <h1 className="text-xs text-[#FF4D4D] variationText">-11.93%</h1>
      <h1 className="text-xs text-[#737BAE]">Ethereum (ETH)</h1>
      <div className="borderDiv mt-4">
        <div className="bg-[#14172B] text-base text-[#ECF0FF]  priceBox">
          <h1 className="text-semibold">$1,466.45</h1>
        </div>
      </div>
